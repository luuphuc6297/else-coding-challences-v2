import {IAuthPassword, IAuthPayloadOptions, IAuthRefreshTokenOptions} from '@infras/auth/interfaces/auth.interface'
...
export class AuthService implements IAuthService {
  ...
  constructor(
    ...
    this.accessTokenExpirationTime = this.configService.get<number>('auth.accessToken.expirationTime') ?? 0
    ...
    this.refreshTokenExpirationTime = this.configService.get<number>('auth.refreshToken.expirationTime') ?? 0
