...
import {IDebuggerHttpConfig, IDebuggerHttpMiddleware} from '@infras/debugger/interfaces/debugger.interface'
...
export class DebuggerHttpMiddleware implements NestMiddleware {
  ...
  constructor(private readonly configService: ConfigService) {
    const writeIntoFile: boolean | undefined = this.configService.get<boolean>('debugger.http.writeIntoFile')
    const writeIntoConsole: boolean | undefined = this.configService.get<boolean>('debugger.http.writeIntoConsole')
